...
public class SerializationTest {
    ...
    public void testImportGraphFromFile() throws IOException {
        ...
        DefaultDirectedGraph<String, LabeledEdge> testGraph1 = utils.dotToFSM("src/test/resources/import1");
        String expectedToString = "([Open, Close, Error], [closeDoor=(Open,Close), closeDoor=(Close,Close), openDoor=(Open,Error)])";
        ...
        String expectedToString2 = "([Not Studying, Studying, Playing], [Study=(Not Studying,Studying), Play=(Not Studying,Playing), " +
